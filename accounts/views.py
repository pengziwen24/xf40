...
#     return render(request,'signupaccounts.html',{'form':})
from django.contrib.auth.forms import UserCreationForm
...
def signupaccounts(request) :
    if request.method == 'GET':
        return render(request,'signupaccounts.html',{'form':UserCreateForm})
    else:
        ...
        if password1 and password2 and password1 == password2:
            ...
            return render(request, 'signupaccounts.html', {'form': UserCreateForm, 'error': '输入的密码不一致'})